...
import com.tinuade.udacity_androidtrivia.databinding.FragmentGameWonBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (args != null) {
            Toast.makeText(context,
                "numberCorrect: ${args.numCorrect}, NumberQuestion: ${args.numQuestions}",Toast.LENGTH_LONG).show()
        }
        return binding.root
    }
